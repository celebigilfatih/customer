...
type SimpleCustomer = { id: string; fullName: string; firmaAdi?: string | null; club?: string | null }
  ...
  useEffect(() => {
    const loadCustomers = async () => {
      try {
        ...
        const items = (data.data || []).map((c) => ({ id: c.id, fullName: c.fullName, firmaAdi: c.firmaAdi, club: c.club }))
        setCustomers(items)
      } catch {}
    }
    loadCustomers()
